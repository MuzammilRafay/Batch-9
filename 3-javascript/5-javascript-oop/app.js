...
//   this.name = "Muzammil"; //properties / encapsulation
//   this.age = 27;
...
//you can create same object with class
class PersonClass {
  constructor(name, age, job) {
    //jab apki class initialize/ call hoo

    //this = current class
    this.name = name; //properties / encapsulation
    this.age = age;
    this.job = job;
  }
}
...
class Parent {
  constructor(name, age, job) {
    this.name = name; //encapsulation //properties
  }
  motherLanguage() {
    //method
    return "urdu";
...
const parentVariable = new Parent("Fathername");
...
childrenVariable.anotherMethod(); //property return
